...
const EnemyType& EnemyType::Swarm() {
    static const auto swarm = EnemyType(Enemy(3, 0.4f, 5, 4),
...
const EnemyType& EnemyType::Grunt() {
    static const auto grunt = EnemyType(Enemy(6, 0.9f, 3.5f, 1),
...
const EnemyType& EnemyType::Quick() {
    static const auto quick = EnemyType(Enemy(3, 0.2f, 7, 7),
...
const EnemyType& EnemyType::Heavy() {
    static const auto heavy = EnemyType(Enemy(10, 0.9f, 2, 1, true),
...
const EnemyType& EnemyType::UberHeavy() {
    static const auto uberHeavy = EnemyType(Enemy(12, 1.0f, 2, 1, true),
