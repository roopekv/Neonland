...
const EnemyType& EnemyType::Grunt() {
    static const auto grunt = EnemyType(Enemy(4, 0.5f, 1),
                                        Mesh(CUBE_MESH, Material(LIT_SHADER, NO_TEX, float4{1.0, 0.37, 0.33, 1})),
                                        float3{1, 1, 1},
                                        10);
    return grunt;
}
const EnemyType& EnemyType::Quick() {
    static const auto quick = EnemyType(Enemy(8, 0.9f, 3),
