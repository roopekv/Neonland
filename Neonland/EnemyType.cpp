...
const EnemyType& EnemyType::Swarm() {
    static const auto swarm = EnemyType(Enemy(6, 0.9f, 4),
...
const EnemyType& EnemyType::Grunt() {
    static const auto grunt = EnemyType(Enemy(4, 0.5f, 1.5f),
...
const EnemyType& EnemyType::Quick() {
    static const auto quick = EnemyType(Enemy(8, 0.9f, 4),
...
const EnemyType& EnemyType::Heavy() {
    static const auto heavy = EnemyType(Enemy(3, 0.9f, 2),
...
const EnemyType& EnemyType::UberHeavy() {
    static const auto uberHeavy = EnemyType(Enemy(3, 0.9f, 1.5f),
